        ...
        `}
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Avatar className="h-9 w-9 ring-2 ring-background dark:ring-gray-700 transition-transform group-hover:scale-110">
                <AvatarImage
                  src={
            ...
            shadow-sm shadow-indigo-500/30 dark:shadow-indigo-500/20
          `}
            >
              {course?.courseLevel}
            </Badge>
